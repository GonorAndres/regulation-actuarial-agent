---
titulo: TÍTULO 1 - CAPÍTULO 1.1
tema: DE LAS DISPOSICIONES PRELIMINARES
titulo_nombre: DE LAS DISPOSICIONES PRELIMINARES
disposiciones: 1.1.1 - 1.1.3
total_disposiciones: 3
palabras_clave: agente, autorización, beneficiario, cartera, comisión, contrato, fianza, fondo, fondos, intermediario, inversión, nota técnica, obligación, patrimonio, prima
---
...
**DISPOSICIÓN 1.1.1.-** .	Para efectos de las presentes Disposiciones, y conforme a lo señalado en el artículo 2 de la Ley de Instituciones de Seguros y de Fianzas, se entenderá por:
...
XIII-Bis. ASG, Acrónimo de Ambiental, Social y de Gobernanza corporativa, cuando se refiere a políticas, factores, criterios, riesgos, materias y principios ambientales, sociales y de gobernanza corporativa de acuerdo con los Objetivos de Desarrollo Sostenible (ODS) de la Agenda 2030 para el Desarrollo Sostenible aprobada el 25 de septiembre de 2015 por la Organización de las Naciones Unidas.

*Adicionado DOF el 05 de junio de 2024
...
XLII.	Créditos Comerciales, los créditos que otorguen las Instituciones y Sociedades Mutualistas a personas morales o personas físicas con actividad empresarial y destinados a su giro comercial, que tengan como garantía:
...
LV.	Estrategia de Inversión, al conjunto de orientaciones elaboradas por la Institución de Seguros para proporcionar Servicios de Inversión Asesorados a sus clientes, con base en las características y condiciones de los mercados, valores e instrumentos financieros derivados en los que se pretenda invertir;
...
LXV.	Garantías Bajo el Esquema de Primeras Pérdidas, las garantías que se aplican en favor de uno o más acreedores, a fin de cubrir en su favor un monto limitado de reservas preventivas que genera un portafolio con un número determinado de créditos, una vez que se actualicen los términos y condiciones pactados para la exigibilidad de la garantía;
...
* Modificada DOF 4-12-2019

**DISPOSICIÓN 1.1.2.-** .	Los términos señalados en la Disposición 1.1.1 podrán utilizarse en singular o en plural, sin que por ello deba entenderse que cambia su significado.

**DISPOSICIÓN 1.1.3.-** .	La Comisión será el órgano competente para interpretar, resolver y aplicar para efectos administrativos lo establecido en las presentes Disposiciones.
