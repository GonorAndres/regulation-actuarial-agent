...
ley: lisf
numero: "237"
titulo: "TÍTULO QUINTO - CAPÍTULO CUARTO"
capitulo: "16"
tema: "TÍTULO QUINTO - CAPÍTULO CUARTO"
categoria: solvencia
palabras_clave: modelo interno de solvencia, autorizacion de modelo interno, prueba de uso, validacion y calibracion del modelo, prueba de solvencia dinamica, documentacion del modelo, experto independiente, modificacion del modelo interno, periodo de dos anos de uso previo
resumen: "Regula la autorizacion y requisitos de los modelos internos que las Instituciones pueden emplear para calcular su requerimiento de capital de solvencia, exigiendo prueba de uso previo de al menos un ano, sistemas de control, recursos humanos calificados, ciclo de validacion periodica, documentacion detallada y opinion favorable de experto independiente. Las modificaciones a los modelos internos requieren autorizacion previa de la CNSF."
refs_internas: [233, 236, 69]
refs_cruzadas: []
---
