...
palabras_clave: sistema de gobierno corporativo, administracion integral de riesgos, control interno, contraloria interna, funcion actuarial, auditoria interna, prueba de solvencia dinamica, autoevaluacion de riesgos y solvencia, tolerancia al riesgo, modelo interno, politicas y procedimientos, revision anual por consejo
resumen: "Articulo 69 de la LISF que establece la obligacion de las Instituciones de contar con un sistema eficaz de gobierno corporativo que incluya administracion integral de riesgos, control interno, funcion actuarial y contratacion con terceros, con autoevaluacion periodica de solvencia y revision anual por el consejo."
refs_internas: [232, 245]
refs_cruzadas: [lisf:232, lisf:245]
---
