...
categoria: solvencia
palabras_clave: variable de perdidas responsabilidad civil, riesgos profesionales, pasivo tecnico proyectado sin margen de riesgo, reserva de riesgos en curso, reserva sonr, esquemas de reaseguro, manual de datos rcs, anexo 6.3.9
resumen: "Establece la fórmula para la variable de pérdidas del ramo de responsabilidad civil y riesgos profesionales en seguros de daños, calculada como la diferencia entre el pasivo técnico proyectado (sin margen de riesgo) y el pasivo al momento del RCS, incluyendo reservas de riesgos en curso y SONR conforme al Anexo 6.3.9."
refs_internas: [6.3.2]
refs_cruzadas: [cusf:6.3.2, cusf:6.3.9]
---
